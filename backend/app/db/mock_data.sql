...
INSERT INTO user_details (user_id, weight, height, age, gender, level)
VALUES
(1, 70.5, 175, 30, 'Male', 'Intermediate'),
(2, 65.0, 160, 28, 'Female', 'Intermediate');

-- Insert mock user details
INSERT INTO user_workout_goal (user_id, workout_goal, muscle, equipment)
VALUES
(1, "Bulking", "Back", "Barbell"),
(2, "Bulking", "Back", "Barbell");
